...
// Derived, not hand-maintained, so a future pattern added to HIGH_CONFIDENCE_PATTERNS
// automatically joins the drift-coverage corpus in sanitize.test.mjs (S7) without anyone
// having to remember to update a second list.
export const HIGH_CONFIDENCE_PATTERN_IDS = HIGH_CONFIDENCE_PATTERNS.map((pattern) => pattern.id);
